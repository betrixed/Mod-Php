...
// dev-tools convention does not have '/' as directory path terminator
defined('BASE_PATH') || define('BASE_PATH', ROOT_DIR . 'private');

defined('APP_PATH') || define('APP_PATH', MOD_DIR . DIRECTORY_SEPARATOR . 'app');
 ...
 */
defined('PTOOLSPATH') || define('PTOOLSPATH', PHP_DIR . 'vendor/phalcon/devtools');
